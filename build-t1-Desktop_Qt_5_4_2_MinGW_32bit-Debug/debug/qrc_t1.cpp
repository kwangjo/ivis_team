...
int QT_RCC_MANGLE_NAMESPACE(qInitResources_t1)();
int QT_RCC_MANGLE_NAMESPACE(qInitResources_t1)()
{
...
int QT_RCC_MANGLE_NAMESPACE(qCleanupResources_t1)();
int QT_RCC_MANGLE_NAMESPACE(qCleanupResources_t1)()
{
...
namespace {
   struct initializer {
       initializer() { QT_RCC_MANGLE_NAMESPACE(qInitResources_t1)(); }
       ~initializer() { QT_RCC_MANGLE_NAMESPACE(qCleanupResources_t1)(); }
   } dummy;
}
